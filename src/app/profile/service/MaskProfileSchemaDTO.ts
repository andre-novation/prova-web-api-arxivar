export type MaskProfileSchemaDTO = {
  maskId?: string;
  maskName?: string;
  translatedMaskName?: string;
  predefinedProfileId?: number;
  options?: ProfileMaskOptionsDTO;
  behaviour?: ProfileMaskBehaviourDTO;
  maskType?: number;
  id?: number;
  document?: FileDTO;
  fields?: FieldBaseDTO[];
...
export type ProfileMaskOptionsDTO = {
  showNotes?: boolean;
  showAttachments?: boolean;
  showFileSelection?: boolean;
  showScannerSelection?: boolean;
  showBarcodeSelection?: boolean;
};

export type ProfileMaskBehaviourDTO = {
